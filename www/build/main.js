...
var HelloIonicPage = (function () {
    ...
    HelloIonicPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-hello-ionic',template:/*ion-inline-start:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/hello-ionic/hello-ionic.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Hello Ionic</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n\n  <h3>Welcome to your first Ionic app!</h3>\n\n  <p>\n    This setup guide will walk you through the steps to create your self trial. A self trial helps\n    you decide whether certain food affects your symptoms.\n  </p>\n  <p>\n    During the trial, you will be asked to eat your trial food on some mornings and to avoid that food\n    on other mornings.\n  </p>\n  <p>\n    We will help you track your progress and symptom levels by sending you daily reminders.\n  </p>\n  <p>\n    <button class="start" ion-button color="primary" menuToggle>Set Up A New Trial</button>\n  </p>\n\n</ion-content>\n'/*ion-inline-end:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/hello-ionic/hello-ionic.html"*/
        }),
...
var ListPage = (function () {
    ...
    ListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>My First List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon name="{{item.icon}}" item-left></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-right>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/list/list.html"*/
        }),
...
var ItemDetailsPage = (function () {
    ...
    ItemDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-details',template:/*ion-inline-start:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/item-details/item-details.html"*/'<ion-header>\n  <ion-navbar>\n    <button menuToggle *ngIf="!selectedItem">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Item Details</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <h3 text-center *ngIf="selectedItem">\n    {{selectedItem.title}}\n    <ion-icon [name]="selectedItem.icon"></ion-icon>\n  </h3>\n  <h4 text-center *ngIf="selectedItem">\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </h4>\n</ion-content>\n'/*ion-inline-end:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/pages/item-details/item-details.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], ItemDetailsPage);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/app/app.html"*/'<ion-menu [content]="content">\n\n	<ion-header>\n		<ion-toolbar>\n			<ion-title>Pages</ion-title>\n		</ion-toolbar>\n	</ion-header>\n\n	<ion-content>\n		<ion-list>\n			<button ion-item *ngFor="let p of pages" (click)="openPage(p)">\n				{{p.title}}\n			</button>\n		</ion-list>\n	</ion-content>\n\n</ion-menu>\n\n<ion-footer>\n	<ion-toolbar>\n		<ion-icon name="search"></ion-icon>\n		<ion-icon name="stats"></ion-icon>\n		<ion-icon name="help"></ion-icon>\n		<ion-icon name="settings"></ion-icon>\n	</ion-toolbar>\n</ion-footer>\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/Users/tejasbharadwaj/Documents/GitHub/TummyTrials-Update/src/app/app.html"*/
        }),
